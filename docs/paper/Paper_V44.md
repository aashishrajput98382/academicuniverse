...
[46] Xu Y, Xu Y, Lv T, Cui L, Wei F,王 X et al. 2021 LayoutLMv2: Multi-modal pre-training for visually-rich document understanding. In: Proceedings of the Association for Computational Linguistics (ACL), pp. 2579–2591.
