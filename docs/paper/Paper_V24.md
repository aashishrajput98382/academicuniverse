...
**Repository & Artifact Build**: `run_1785959173886` | Dataset Hash: `17c136ef76dd0f82` | Commit: `f378063`  
...
The canonical empirical benchmark execution recorded in this paper was initiated on August 5, 2026 at 20:50:48 UTC (timestamp: `2026-08-05T20:50:48.067Z`, total execution duration: 2917.90s / 48.63 mins) under run identifier `run_1785959173886`. The evaluation codebase corresponds to Git commit `f378063` hosted in the official project repository (`https://github.com/aashishrajput9838/academicuniverse.git`). The synthetic benchmark dataset (`AU_DIC_Benchmark_v1.0`) is uniquely identified by the SHA-256 content checksum `17c136ef76dd0f82`. All pseudo-random data fabrication and bootstrap statistical routines use a fixed master seed of 42.
...
| Document Intelligence Architecture | Model Paradigm / Pipeline | Evaluation Origin & Provenance | Vector PDFs (5 Files) | PNG/JPEG Images (40 Files) | Overall Field F1 | Character Error Rate (CER) | Robustness & Empirical Summary |
| :--- | :--- | :--- | :---: | :---: | :---: | :---: | :--- |
