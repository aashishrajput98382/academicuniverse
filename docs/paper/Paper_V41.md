...
| :--- | :--- | :--- |
| **Benchmark Suite** | `AU_DIC_Benchmark_v1.0` | Canonical 450-specimen multi-modal evaluation dataset |
...
| :--- | :--- | :--- | :---: | :---: | :---: | :---: | :--- |
| **Classical Vector Extractor** [19] | Direct Text Stream (PyMuPDF) | **Direct Live Run (AU DIC 450 Specimens)** | 33.33% | 11.11% | **11.11%** | 88.89% | *Baseline: Fails completely on raster image photos* |
| **OCR + Spatial Heuristic Parser** [20] | Tesseract 5.3 + Layout Rules | **Direct Live Run (AU DIC 450 Specimens)** | 68.89% | 62.20% | **52.22%** | 38.40% | *Baseline: Degrades under optical noise & rotation* |
| **Pure Foundation VLM (MiniCPM-V)** [31] | Zero-Shot Neural Pixel Ingestion | **Direct Live Run (AU DIC 450 Specimens - Pass A)** | 100.00% | 96.00% | **81.77%** | 8.14% | *Baseline: Neural vision penalized by raw formatting* |
| **Proposed AU DIC System (Ours)** | **Neural VLM + 6-Stage CanonicalNormalizer** | **Direct Live Run (AU DIC 450 Specimens - Pass B)** | **100.00%** | **96.00%** | **92.92%** | **2.45%** | **🏆 State-of-the-Art (SOTA) on AU DIC Suite (+11.16% Gain)** |
