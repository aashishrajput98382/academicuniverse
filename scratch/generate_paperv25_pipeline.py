...
fig1_path = workspace / "docs" / "paper" / "figure1_system_architecture_mermaid.png"
fig2_path = workspace / "docs" / "paper" / "figure2_data_flow_mermaid.png"
...
v25_docx_path = workspace / "docs" / "paper" / "PaperV25_Ollama_Primary.docx"
v25_pdf_path = workspace / "docs" / "paper" / "PaperV25_Ollama_Primary.pdf"

print("============================================================")
print(" GENERATING PAPER V25 (ELEGANT LITERATURE & SOTA TABLES) (BENCHMARK PROVENANCE & SOTA INTEGRATED) (STATE-OF-THE-ART BENCHMARK INTEGRATED) (MULTI-MODAL VISION BENCHMARK INTEGRATED) (CONCLUSION & FUTURE WORK SWAPPED & ENHANCED)")
print("============================================================")
...
# Scale oversized drawings to fit vertically within page budget (<= 20 Pages)
for p in doc.paragraphs:
    for r in p.runs:
...
# Table 7 / 8 (State-of-the-Art SOTA Benchmark Comparison with Provenance)
if len(doc.tables) > 6:
    t7 = doc.tables[6]
    t7_data = [
...
doc.save(v25_docx_path)
print(f"[SUCCESS] Saved clean PaperV25_Ollama_Primary.docx with Conclusion & Future Work swapped & enhanced!")

# Export PDF via Word COM Automation
print(f"Exporting PDF via Word COM Automation: {v25_pdf_path.name}...")
abs_docx = os.path.abspath(str(v25_docx_path))
abs_pdf = os.path.abspath(str(v25_pdf_path))
...
try:
    ...
    doc_word.Close()
    print(f"[SUCCESS] Exported high-quality PDF: {v25_pdf_path.name} ({page_count} Pages!)")
