...
v24_docx_path = workspace / "docs" / "paper" / "PaperV24_Ollama_Primary.docx"
v24_pdf_path = workspace / "docs" / "paper" / "PaperV24_Ollama_Primary.pdf"

print("============================================================")
print(" GENERATING PAPER V24 (BENCHMARK PROVENANCE & SOTA INTEGRATED) (STATE-OF-THE-ART BENCHMARK INTEGRATED) (MULTI-MODAL VISION BENCHMARK INTEGRATED) (CONCLUSION & FUTURE WORK SWAPPED & ENHANCED)")
print("============================================================")
...
doc.save(v24_docx_path)
print(f"[SUCCESS] Saved clean PaperV24_Ollama_Primary.docx with Conclusion & Future Work swapped & enhanced!")

# Export PDF via Word COM Automation
print(f"Exporting PDF via Word COM Automation: {v24_pdf_path.name}...")
abs_docx = os.path.abspath(str(v24_docx_path))
abs_pdf = os.path.abspath(str(v24_pdf_path))
...
try:
    ...
    doc_word.Close()
    print(f"[SUCCESS] Exported high-quality PDF: {v24_pdf_path.name} ({page_count} Pages!)")
