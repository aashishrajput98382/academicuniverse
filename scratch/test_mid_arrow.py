...
def test_mid_arrow():
    ...
    plt.tight_layout()
    plt.savefig("scratch/fig2_mid_arrow.png", bbox_inches='tight', dpi=300)
    plt.close()
    print("Generated scratch/fig2_mid_arrow.png")
