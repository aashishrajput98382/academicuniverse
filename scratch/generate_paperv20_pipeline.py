...
v20_docx_path = workspace / "docs" / "paper" / "PaperV20_Ollama_Primary.docx"
v20_pdf_path = workspace / "docs" / "paper" / "PaperV20_Ollama_Primary.pdf"

print("============================================================")
print(" GENERATING PAPER V20 (CONCLUSION & FUTURE WORK SWAPPED & ENHANCED)")
print("============================================================")
...
doc.save(v20_docx_path)
print(f"[SUCCESS] Saved clean PaperV20_Ollama_Primary.docx with Conclusion & Future Work swapped & enhanced!")

# Export PDF via Word COM Automation
print(f"Exporting PDF via Word COM Automation: {v20_pdf_path.name}...")
abs_docx = os.path.abspath(str(v20_docx_path))
abs_pdf = os.path.abspath(str(v20_pdf_path))
...
try:
    ...
    doc_word.Close()
    print(f"[SUCCESS] Exported high-quality PDF: {v20_pdf_path.name} ({page_count} Pages!)")
