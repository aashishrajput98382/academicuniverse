...
v14_docx_path = workspace / "docs" / "paper" / "PaperV14_Ollama_Primary.docx"
v14_pdf_path = workspace / "docs" / "paper" / "PaperV14_Ollama_Primary.pdf"

print("============================================================")
print(" GENERATING PAPER V14 (CONCLUSION & FUTURE WORK SWAPPED & ENHANCED)")
print("============================================================")
...
# V12 Table of Contents entries: Clean 7 sections (6. Conclusion, 7. Future Work)
toc_entries = [
    ("1. Introduction", "4", 1),
    ("2. Related Work", "5", 1),
    ("3. Methodology", "7", 1),
...
doc.save(v14_docx_path)
print(f"[SUCCESS] Saved clean PaperV14_Ollama_Primary.docx with Conclusion & Future Work swapped & enhanced!")

# Export PDF via Word COM Automation
print(f"Exporting PDF via Word COM Automation: {v14_pdf_path.name}...")
abs_docx = os.path.abspath(str(v14_docx_path))
abs_pdf = os.path.abspath(str(v14_pdf_path))
...
try:
    ...
    doc_word.Close()
    print(f"[SUCCESS] Exported high-quality PDF: {v14_pdf_path.name} ({page_count} Pages!)")
