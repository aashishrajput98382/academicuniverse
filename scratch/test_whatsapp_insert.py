...
test_docx = r'c:\github\academicuniverse\scratch\test_wa.docx'
test_pdf = r'c:\github\academicuniverse\scratch\test_wa.pdf'
...
for pno in range(len(pdf)):
    ...
    pix.save(f"scratch/wa_page_{pno+1}.png")
    print(f"Rendered scratch/wa_page_{pno+1}.png")
