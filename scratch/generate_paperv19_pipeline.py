...
v19_docx_path = workspace / "docs" / "paper" / "PaperV19_Ollama_Primary.docx"
v19_pdf_path = workspace / "docs" / "paper" / "PaperV19_Ollama_Primary.pdf"

print("============================================================")
print(" GENERATING PAPER V19 (CONCLUSION & FUTURE WORK SWAPPED & ENHANCED)")
print("============================================================")
...
doc.save(v19_docx_path)
print(f"[SUCCESS] Saved clean PaperV19_Ollama_Primary.docx with Conclusion & Future Work swapped & enhanced!")

# Export PDF via Word COM Automation
print(f"Exporting PDF via Word COM Automation: {v19_pdf_path.name}...")
abs_docx = os.path.abspath(str(v19_docx_path))
abs_pdf = os.path.abspath(str(v19_pdf_path))
...
try:
    ...
    doc_word.Close()
    print(f"[SUCCESS] Exported high-quality PDF: {v19_pdf_path.name} ({page_count} Pages!)")
