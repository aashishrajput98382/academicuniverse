...
print("============================================================")
print(" GENERATING PAPER V26 (ENTITY ACCURACY SOTA BENCHMARK) (ELEGANT LITERATURE & SOTA TABLES) (BENCHMARK PROVENANCE & SOTA INTEGRATED) (STATE-OF-THE-ART BENCHMARK INTEGRATED) (MULTI-MODAL VISION BENCHMARK INTEGRATED) (CONCLUSION & FUTURE WORK SWAPPED & ENHANCED)")
print("============================================================")
...
# Table 7 / 8 (State-of-the-Art SOTA Benchmark Comparison with Category & Name Accuracy)
if len(doc.tables) > 6:
    t7 = doc.tables[6]
    t7_data = [
...
print(f"[SUCCESS] Saved clean PaperV26_Ollama_Primary.docx with Conclusion & Future Work swapped & enhanced!")

# Export PDF via Word COM Automation
print(f"Exporting PDF via Word COM Automation: {v26_pdf_path.name}...")
abs_docx = os.path.abspath(str(v26_docx_path))
abs_pdf = os.path.abspath(str(v26_pdf_path))
