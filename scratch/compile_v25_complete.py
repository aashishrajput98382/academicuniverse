...
# 1. Run pipeline
subprocess.run(["python", "scratch/generate_paperv25_pipeline.py"], check=True)

# 2. Open docx
doc = docx.Document(v25_docx_path)
...
print("=== EXACT MAPPING OF ALL 9 FIGURES IN V25 ===")
...
print(f"[SUCCESS] Saved beautifully styled PaperV25_Ollama_Primary.docx!")
...
try:
    doc_word = word.Documents.Open(os.path.abspath(str(v25_docx_path)))
    doc_word.SaveAs(os.path.abspath(str(v25_pdf_path)), FileFormat=17)
